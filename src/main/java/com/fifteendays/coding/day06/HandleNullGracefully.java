...
public class HandleNullGracefully {
    ...
    public static void main(String[] args) {
        HandleNullGracefully handleNullGracefully = new HandleNullGracefully();
        handleNullGracefully.init();

       List<Employee> optionalEmployees = Optional.ofNullable(handleNullGracefully.employees).orElse(Collections.emptyList());
